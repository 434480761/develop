...
import nd.esp.service.lifecycle.vos.ebooks.v06.EbookExtPropertiesViewModel;
import nd.esp.service.lifecycle.vos.ebooks.v06.EbookViewModel;
import nd.esp.service.lifecycle.vos.questions.v06.QuestionExtPropertyViewModel;
...
public class TestEbookController extends SimpleJunitTest4ResourceImpl {
	...
	public void testAll(){
		...
		EbookViewModel qvm = BeanMapperUtils.beanMapper(getDefaultResouceViewModel(), EbookViewModel.class);
		EbookExtPropertiesViewModel qevm = new EbookExtPropertiesViewModel();
		Map<String,String> m = new HashMap<String, String>();
		m.put("key", "value");
		qevm.setIsbn("test isbn");
		qvm.setExtProperties(qevm);
		postCreate(RES_TYPE, uuid2, ObjectUtils.toJson(qvm));
