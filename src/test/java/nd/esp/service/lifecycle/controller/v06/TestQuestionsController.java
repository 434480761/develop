...
public class TestQuestionsController extends SimpleJunitTest4ResourceImpl {
	...
	public void testAll(){
		...
		QuestionViewModel qvm = BeanMapperUtils.beanMapper(getDefaultResouceViewModel(), QuestionViewModel.class);
		QuestionExtPropertyViewModel qevm = new QuestionExtPropertyViewModel();
		Map<String,String> m = new HashMap<String, String>();
		m.put("key", "value");
		qevm.setItemContent(m);
