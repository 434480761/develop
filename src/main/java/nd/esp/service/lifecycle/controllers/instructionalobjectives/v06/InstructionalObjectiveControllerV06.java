...
public class InstructionalObjectiveControllerV06 {
    ...
    //===== copy from NDResourceController start =====
    ...
    //===== copy from NDResourceController end =====
     ...
     * @param printableKey 指定资源哪个文件可打印(针对TI中的title),只有当printable!=null的时候生效
     * @return
     */
    @RequestMapping(value = "/business/actions/query", method = RequestMethod.GET, produces = { MediaType.APPLICATION_JSON_VALUE },params = { "words","limit"})
    public ListViewModel<ResourceViewModel> requestQueryingByDBAndBusiness(
        ...
        String resType = "instructionalobjectives"; //这里固定是教学目标
