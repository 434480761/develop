...
public class TitanCommonRepositoryImpl implements TitanCommonRepository {
    ...
    @Override
    public void addSetProperty(String identifier, String primaryCategory, String fieldName, List<String> values) {
    ...
    @Override
    public void deleteNodeField(String identifier, String primaryCategory, String fieldName) {
        String script =  "g.V().has(primaryCategory,'identifier',identifier).properties(fieldName).drop()";
        Map<String, Object> param = new HashMap<>();
        param.put("primaryCategory",primaryCategory);
        param.put("identifier",identifier);
    ...
    private List<Double> submitListDouble(String script, Map<String, Object> params) throws RuntimeException {
    ...
    private List<Long> submitListLong(String script, Map<String, Object> params) throws RuntimeException {
    ...
    private void submitScript(String script, Map<String, Object> params) {
        try {
            ResultSet resultSet = client.submit(script, params);
            Iterator<Result> iterator = resultSet.iterator();
            if (iterator.hasNext()) {
    ...
    private ResultSet submitScriptResultRet(String script, Map<String, Object> params){
     ...
     */
    private Long submitUniqueLong(String script, Map<String, Object> params) throws RuntimeException {
        Long id = null;
        try {
            ResultSet resultSet = client.submit(script, params);
            Iterator<Result> iterator = resultSet.iterator();
     ...
     * id==null 节点不存在或提交出现异常
     */
    private String submitUniqueString(String script, Map<String, Object> params) throws RuntimeException {
        String id = null;
        try {
            ResultSet resultSet = client.submit(script, params);
            Iterator<Result> iterator = resultSet.iterator();
