package nd.esp.service.lifecycle.daos.Icrs1.v06;
...
public interface Icrs1Dao {
	 ...
	 * @return
	 */
	List<ResourceTotalModel> getResourceTotal(String schoolId, String fromDate, String toDate);
	 ...
	 * @return
	 */
	List<DailyDataViewModel> getResourceStatisticsByDay(String schoolId,String resType, String fromDate, String toDate);
