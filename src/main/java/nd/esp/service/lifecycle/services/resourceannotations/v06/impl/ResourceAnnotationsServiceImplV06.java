 ...
 */
@Service(value="resourceAnnotationsServiceImplV06")
@Primary
@Transactional(value="transactionManager")
public class ResourceAnnotationsServiceImplV06 implements ResourceAnnotationsServiceV06 {
    private final static Logger LOG = LoggerFactory.getLogger(ResourceAnnotationsServiceImplV06.class);
    
    @Autowired
    ResourceAnnotationRepository resourceAnnotationRepository;
