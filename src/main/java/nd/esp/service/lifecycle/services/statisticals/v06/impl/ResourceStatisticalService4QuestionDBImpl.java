...
@Service("StatisticalService4QuestionDBImpl")
@Transactional(value="questionTransactionManager")
public class ResourceStatisticalService4QuestionDBImpl implements ResourceStatisticalService {
    private final Logger LOG = LoggerFactory.getLogger(CourseWareObjectServiceImplV06.class);

    @Autowired
    private ResourceStatistical4QuestionDBRepository statisticalRepository;

    @Autowired
    @Qualifier(value = "ResourceStatisticalsDao4QuestionDBImpl")
