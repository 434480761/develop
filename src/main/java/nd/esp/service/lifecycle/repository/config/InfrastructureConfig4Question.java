...
public class InfrastructureConfig4Question {
	@Resource
	private Environment env;
	
	public final static String HIBERNATE_CONFIG = "sdkdb/hibernate_question.properties";
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(
			@Qualifier(value="questionDataSource") DataSource dataSource, @Qualifier(value="questionProp")Properties hibProperties) {
	...
	public PlatformTransactionManager transactionManager(@Qualifier(value="questionEntityManagerFactory") LocalContainerEntityManagerFactoryBean entityManagerFactory) {
	...
	@Autowired
	@Bean
	public TransactionTemplate getTransactionTemplate(@Qualifier(value="questionDataSource") DataSource dataSource,@Qualifier(value="questionProp") Properties hibProperties){
	...
	@Autowired
	@Bean(name="questionJdbcTemplate")
	public JdbcTemplate questionJdbcTemplate(@Qualifier(value="questionDataSource") DataSource dataSource){
		return new JdbcTemplate(dataSource);
	}
	
	@Autowired
	@Bean(name="questionTransactionTemplate")
	public TransactionTemplate getQuestionTransactionTemplate(@Qualifier(value="questionDataSource") DataSource dataSource, @Qualifier(value="questionProp")Properties hibProperties){
