...
public enum ElasticSearchReservedWords {
	...
	// KEYWORD("keyword"),
	// STANDARD("standard"),
	PROPERTIES("properties"), DATE("date"),
	// DATE_FORMATS("date_formats"),
	// FORMAT("format"),
	STORE("store"), YES("yes"), INDEX("index"), NOT_ANALYZED("not_analyzed"), FLOAT(
			"float"), BOOLEAN("boolean"), STRING("string"), DOUBLE("double"), Long(
			"long"), IGNORE_ABOVE("ignore_above"),
	// FIELDS("fields"),
	// MULTI_FIELD("multi_field"),
	// INDEX_MAPPER_DYNAMIC("index.mapper.dynamic"),
	// DEFAULT("_default_"),
	DYNAMIC("dynamic"), STRICT("strict"),
	// SOURCE("_source"),
	// ENABLED("enabled"),
	INTEGER("integer"), CLUSTER_NAME("cluster.name"), CLIENT_TRANSPORT_SNIFF(
