package com.nd.esp.task.worker.buss.packaging.service;
 ...
 */
public interface PackageService extends TaskRun {
...
//    double queryPack(String url, String errMsg);
     ...
     * 打包下载的请求，获取下载地址
     * 
     * @param PackagingParam  打包参数
     * @param id              打包资源id
     * @param logMsg          输出在任务监控的日志信息
     * 
     */
//    Map<String, Map<String, String>> archivingLocal(String id, PackagingParam param, StringBuffer logMsg)
//            throws Exception;

//    String UploadFileToCS(byte[] bytes, String csPath, String fileName, String session, String csApiUrl,
//            StringBuffer logMsg) throws Exception;
