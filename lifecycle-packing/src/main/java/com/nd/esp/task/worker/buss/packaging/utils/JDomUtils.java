...
public class JDomUtils {
	...
	private final static Log LOG = LogFactory.getLog(JDomUtils.class);
    ...
    public final static String ADDNODE_DEST_ATTRIBUTE="dest";
    /**sdp-package.xml dest属性名称*/
    public final static String ADDNODE_UNZIP_ATTRIBUTE="unzip";
    ...
    public final static String REF_PATH_ADDON="${ref-path-addon}";
	
	/**sdp-package.xml 相对压缩包路径*/
    public final static String PACK_REF_PATH="/_ref";
     ...
     * @author qil
     */
    private static String getRefpathHeader(String downloadPath, String addonInstance) {
        Assert.assertNotNull("downloadPath不能为空", downloadPath);
     ...
     * @throws Exception
     */
    public static void generatorPackPath(Map<String, Map<String, String>> pathsGrpMap,
        ...
        if(isInit) {
            ...
            String zipFileTempDir = JDomUtils.class.getClassLoader().getResource("").getPath()
            ...
            long timeCount = System.currentTimeMillis()-timeStart;
            if(timeCount>1000*60*5) {
                throw new Exception("解析xml文件超时：解析xml文件超过5min,可能存在循环嵌套");
            }
        }
    ...
    static class DownloadXmlThread implements Callable<DownloadXmlThread> {
     ...
     */
    public static String AccessXmlFile(String path,String header,
